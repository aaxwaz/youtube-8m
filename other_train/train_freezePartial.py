...
def build_graph(reader,
  ...
  video_vars = set(['tower/embeddings:0',
                    'tower/project_mat:0',
                    'tower/gates/weights:0',
                    'tower/experts/weights:0',
                    'tower/experts/biases:0',
                    'tower/output_bn_1/beta:0',
                    'tower/output_bn_1/gamma:0',
                    'tower/gating_layer_0/weights:0',
                    'tower/gating_prob_bn_0/beta:0',
                    'tower/gating_prob_bn_0/gamma:0',
                    'tower/output_layer_2/weights:0',
                    'tower/output_bn_2/beta:0',
                    'tower/output_bn_2/gamma:0',
                    'tower/gating_layer_1/weights:0',
                    'tower/gating_prob_bn_1/beta:0',
                    'tower/gating_prob_bn_1/gamma:0',
                    'tower/output_layer/weights:0',
                    'tower/output_bn/beta:0',
                    'tower/output_bn/gamma:0',
                    'tower/gating_layer/weights:0',
                    'tower/gating_prob_bn/beta:0',
                    'tower/gating_prob_bn/gamma:0'])

  frame_vars = set(['tower/input_bn/beta:0',
                    'tower/input_bn/gamma:0',
                    ...
                    'tower/audio_VLAD/cluster_bn/gamma:0',
                    'tower/hidden1_weights:0',
                    'tower/hidden2_weights:0',
                    'tower/SVD_mat1_biases:0',
                    'tower/SVD_mat2_biases:0',
                    'tower/hidden1_bn/beta:0',
                    'tower/hidden1_bn/gamma:0',
                    'tower/gating_weights_2:0',
                    'tower/gating_bn/beta:0',
                    'tower/gating_bn/gamma:0'])

  all_vars_to_save = [v[1] for v in merged_gradients]

  if FLAGS.freeze_frame:
    merged_gradients = [i for i in merged_gradients if i[1].name not in frame_vars]

  if FLAGS.freeze_video:
    merged_gradients = [i for i in merged_gradients if i[1].name not in video_vars]
...
#                           task_as_string(self.task))
  ...
  def build_model(self, model, reader):
    ...
    all_vars_to_save = build_graph(reader=reader,
                                   model=model,
    ...
    return tf.train.Saver(all_vars_to_save, max_to_keep=0, keep_checkpoint_every_n_hours=FLAGS.save_checkpoint_every_n_hour)
